...
```{r STH_locations, fig.cap= "STH data collection locations.", fig.height=10}
...
plot_grid(plot.list$HK$altitude, plot.list$HK$fric_w,plot.list$HK$travel_w,
          plot.list$HK$riv_dist,plot.list$HK$fric_m, plot.list$HK$travel_m,
          labels = c("A", "C", "E", "B", "D", "F"),
          align = "hv")
