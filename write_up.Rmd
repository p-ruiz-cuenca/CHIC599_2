...
These are described in [TABLE REF].
I used this model to create the same three rasters as I did for hookworms: predicted prevalence, probability of having between 20% and 50% prevalence and probability of exceeding 50% prevalence [Figure REF]. 
